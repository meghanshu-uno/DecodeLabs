...
(function () {
  ...
  const TRACKS_DATA = [
    {
      ...
      duration: '6 Weeks',
      modules: '18 Modules',
      projectsCount: '6 Capstones',
      rating: '4.94',
      ratingCount: 342,
      description: 'Master semantic HTML5 layout engines, CSS Grid/Flexbox architectures, fluid clamp() typography, and modular Vanilla JS DOM patterns without bloated framework abstractions.',
      tags: ['HTML5', 'CSS Grid', 'Vanilla JS', 'WCAG AA'],
      outcomes: [
        'Build responsive, production-ready design systems from scratch',
        'Implement WCAG 2.1 AA keyboard accessibility and ARIA patterns',
        'Optimize rendering critical path, reflows, and Core Web Vitals',
        'Manage asynchronous client-side state without external libraries'
      ],
      capstone: 'Enterprise-grade Component Design System & Responsive Analytics Dashboard with zero external dependencies.'
    },
    {
      id: 'track-distributed-node',
      title: 'High-Throughput Node.js & Distributed Systems',
      category: 'backend',
      level: 'advanced',
      levelLabel: 'Advanced',
      duration: '8 Weeks',
      modules: '24 Modules',
      projectsCount: '8 Capstones',
      rating: '4.97',
      ratingCount: 289,
      description: 'Deep-dive into the Node.js event loop, asynchronous stream pipelines, Redis distributed caching, connection pooling, and resilient microservice communication.',
      tags: ['Node.js', 'PostgreSQL', 'Redis', 'Microservices'],
      outcomes: [
        'Architect non-blocking I/O backends capable of 50k+ req/sec',
        'Design ACID compliant PostgreSQL database schemas & index strategies',
        'Implement distributed token revocation, rate-limiting & OAuth2/JWT',
        'Build fault-tolerant event streams with message brokers'
      ],
      capstone: 'High-Throughput Real-Time Financial Ledger Service with distributed lock managers and database replication.'
    },
    {
      id: 'track-k8s-cloud',
      title: 'Cloud-Native Kubernetes & AWS DevOps',
      category: 'cloud',
      level: 'advanced',
      levelLabel: 'Advanced',
      duration: '7 Weeks',
      modules: '20 Modules',
      projectsCount: '5 Capstones',
      rating: '4.89',
      ratingCount: 195,
      description: 'Containerize multi-tier applications with multi-stage Docker builds and orchestrate resilient, auto-scaling workloads on AWS EKS with Prometheus & Grafana telemetry.',
      tags: ['Docker', 'Kubernetes', 'AWS EKS', 'CI/CD'],
      outcomes: [
        'Write secure, rootless Dockerfiles with minimal image surface area',
        'Deploy production Kubernetes clusters with Ingress, Secrets & HPA',
        'Automate blue/green and canary deployment pipelines via GitOps',
        'Set up end-to-end distributed tracing using OpenTelemetry'
      ],
      capstone: 'Multi-Region High-Availability Cluster with automated chaos testing and zero-downtime rolling upgrades.'
    },
    {
      id: 'track-css-layouts',
      title: 'CSS3 Deep Dive: Layouts, Grids & Micro-Interactions',
      category: 'frontend',
      level: 'beginner',
      levelLabel: 'Beginner - Intermediate',
      duration: '4 Weeks',
      modules: '14 Modules',
      projectsCount: '4 Capstones',
      rating: '4.92',
      ratingCount: 418,
      description: 'Unlock complete visual mastery of modern CSS. Create fluid layouts with clamp(), complex CSS Grid layouts, fluid subgrids, CSS custom property theming, and hardware-accelerated animations.',
      tags: ['CSS3', 'Grid & Flex', 'clamp()', 'Animation'],
      outcomes: [
        'Eliminate responsive layout bugs across any mobile/desktop viewport',
        'Construct bespoke CSS token systems with CSS Custom Properties',
        'Animate state transitions with 60fps performance and reduced-motion support',
        'Master CSS specificity, cascade layers, and maintainable architectures'
      ],
      capstone: 'Polished Interactive Web Application Interface with multi-theme switching and custom glassmorphism components.'
    },
    {
      id: 'track-rest-graphql',
      title: 'Enterprise API Design: REST, GraphQL & gRPC',
      category: 'backend',
      level: 'intermediate',
      levelLabel: 'Intermediate',
      duration: '5 Weeks',
      ...
      rating: '4.88',
      ratingCount: 260,
      description: 'Design, version, and document clean APIs. Learn the trade-offs between RESTful resource models, flexible GraphQL schemas with DataLoader, and ultra-fast gRPC binary protocols.',
      tags: ['REST', 'GraphQL', 'gRPC', 'API Security'],
      outcomes: [
        'Structure robust RESTful contracts with OpenAPI/Swagger standards',
        'Solve the N+1 query problem in GraphQL using batching & caching',
        'Secure API gateways with rate-limiting, CORS, and HMAC validation',
        'Implement end-to-end integration test suites with CI/CD automation'
      ],
      capstone: 'Universal E-Commerce API Gateway handling REST, GraphQL, and WebSocket subscriptions.'
    },
    {
      id: 'track-fullstack-capstone',
      title: 'Enterprise Full Stack Architecture Capstone',
      category: 'fullstack',
      level: 'advanced',
      levelLabel: 'Advanced Architecture',
      duration: '10 Weeks',
      modules: '32 Modules',
      projectsCount: '1 Signature Capstone',
      rating: '4.98',
      ratingCount: 512,
      description: 'The ultimate synthesis program: Build a complete production SaaS platform from semantic frontend components to distributed backend microservices deployed on Kubernetes.',
      tags: ['Full Stack', 'Architecture', 'Kubernetes', 'SaaS'],
      outcomes: [
        'Architect end-to-end web applications with clean separation of concerns',
        'Manage full DevOps lifecycles, automated testing, and CI/CD pipelines',
        'Implement enterprise security, telemetry, and observability logging',
        'Deliver a portfolio-ready product verified by industry senior staff engineers'
      ],
      capstone: 'Complete Multi-Tenant Collaborative Developer Platform with live code execution and billing integration.'
    }
  ];
  ...
  // Save/Unsave Track
  function toggleTrackBookmark(trackId) {
    const index = state.savedTrackIds.indexOf(trackId);
    let isSaved = false;

    if (index > -1) {
      state.savedTrackIds.splice(index, 1);
      isSaved = false;
